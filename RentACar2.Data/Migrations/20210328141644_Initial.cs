...
namespace RentACar2.Data.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Ahmet", "İzmir", "05556667788", null, "ahmet@gmail.com", "Yılmaz", "11111111110" },
                    { 2, "Mehmet", "İzmir", "05556667788", null, "mehmet@gmail.com", "Yılmaz", "11111111110" },
                    { 3, "Ali", "İzmir", "05556667788", null, "ali@gmail.com", "Yılmaz", "11111111110" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "İzmir", "atmacalper@atmacalper.com", "0535210", "AtmacAlpers", "A123" },
                    { 2, "İzmir", "uygurs@me.com", "0326569", "Uygurs", "Y125" },
                    { 3, "İzmir", "dagdeviren@dagdeviren.com", "0789542", "Dagdevirens", "D567" }
                });
